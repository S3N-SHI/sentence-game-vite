# Script para crear GameController
Write-Host "Creando GameController..." -ForegroundColor Cyan
...
export class GameController {
  ...
  victoria() {
    ...
    this.ui.mostrarVictoria(tiempoTotal, this.state.totalErrores, this.state.totalSorteos, this.state.probabilidadActual);
    this.limpiarEventListeners();
  }
...
"@ | Out-File "src\game\GameController.js" -Encoding UTF8
Write-Host "- GameController.js creado" -ForegroundColor Green